...
import { AddBusinessContactDrawer } from './AddBusinessContactDrawer'
...
interface BusinessContactListProps {
    contacts?: Contact[]
    isLoading?: boolean
    title?: string
...
}: BusinessContactListProps = {}) {
    const { data: fetchedContacts, isLoading: isQueryLoading, error } = useBusinessContacts()
