...
export default function FriendInvitePage(props: PageProps) {
        ...
        const acceptInvite = async () => {
            try {
                ...
                if (!session) {
                    ...
                    router.push(`/auth?returnUrl=/invite/friend/${token}`)
                    return
                }
                ...
                setStatus('SUCCESS')
                setMessage(`Success! You are now friends with ${data.target_name}. Redirecting...`)
